...
class EditUserPage(TemplatePage):
    def __init__(self, page: ft.Page, user, on_save=None):
        ...
        self.verified_email = (
            self.user_email
        )  # Track the currently verified email address
    ...
    def build(self) -> ft.View:
        ...
        app_bar = ft.AppBar(
            ...
            leading=ft.IconButton(
                ft.Icons.ARROW_BACK, on_click=lambda _: self.page.views.pop()
            ),
        ...
        self.email_field = TextField(
            ...
            suffix_icon=ft.Button(
                content="Verify email", visible=False, on_click=self.on_verify_click
            ),
        ...
        self.otp_dialog = AlertDialog(
            ...
            content=ft.Container(
                ft.Column(
                    ...
                    controls=[
                        ft.Text(
                            "A 6-digit verification code has been sent to", size=14
                        ),
            ...
            actions=[
                ...
                ft.TextButton(
                    ...
                    on_click=lambda _: self.page.run_task(
                        self.verify_new_email, self.otp_field.value, new_email
                    ),
                ),
            ],
        )
    ...
    async def verify_new_email(self, otp_value, email):
        ...
        self.otp_field.suffix_icon = ft.Container(ft.ProgressRing(height=20, width=20))
        self.page.update()
